...
argument_parser = argparse.ArgumentParser(description='A tool for reporting telegram channels by t.me/VerityIntel', add_help=False)
...
if command_line_args.help:
  ...
  -h, --help ~> {Fore.YELLOW}show help{Fore.RESET}''')
    ...
    print(f"""
    _____    _ __    t.me/{Fore.MAGENTA}VerityIntel{Fore.RESET}    💀
